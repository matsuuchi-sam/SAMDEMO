/*
* Copyright (c) 2013(2015,2025) Renesas Electronics Corporation and/or its affiliates
*
* SPDX-License-Identifier: BSD-3-Clause
*/
/************************************************************************/
/*    File Version: V1.80A                                              */
/*    History: 1.10a (2013-06-18)  [Hardware Manual Revision : 1.00]    */
/*           : 1.80  (2015-04-22)  [Hardware Manual Revision : 1.80]    */
/*           : 1.80A (2025-04-21)  [Hardware Manual Revision : 1.80]    */
/************************************************************************/
